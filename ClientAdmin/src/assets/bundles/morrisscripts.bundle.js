!function (a, b) {
  ...
  return function (a) {
    ...
    d = [c(2)], void 0 !== (e = function (a) {
      ...
      function i(a, b, c, d, e, f, g, i, j) {
        ...
        for (var k = j / 2, l = [-.1252, .1252, -.3678, .3678, -.5873, .5873, -.7699, .7699, -.9041, .9041, -.9816, .9816], m = [.2491, .2491, .2335, .2335, .2032, .2032, .1601, .1601, .1069, .1069, .0472, .0472], n = 0, o = 0; 12 > o; o++) {
          var p = k * l[o] + k, q = h(p, a, c, e, g), r = h(p, b, d, f, i), s = q * q + r * r;
          n += m[o] * M.sqrt(s)
        }
        return k * n
      }
      ...
      function p(a, b, c, d, e, f) {
        ...
        var i = 3 * b, j = 3 * (d - b) - i, k = 1 - i - j, l = 3 * c, m = 3 * (e - c) - l, n = 1 - l - m;
        return function (a, b) {
          var c = h(a, b);
          return ((n * c + m) * c + l) * c
        }(a, 1 / (200 * f))
      ...
      function r(c, d, e, f, g, h) {
        ...
        if (i) {
          if (j) j.initstatus = f, j.start = new Date - j.ms * f; else {
            ...
            if (!P) if ((P = H(O).match(Y)) && 5 == P.length) {
              var Q = P;
              P = function (a) {
      ...
      var t, u, v = /[, ]+/, w = {circle: 1, rect: 1, path: 1, ellipse: 1, text: 1, image: 1}, x = /\{(\d+)\}/g,
        ...
        E = "ontouchstart" in z.win || z.win.DocumentTouch && z.doc instanceof DocumentTouch, F = "", G = " ",
        H = String, I = "split",
      ...
      var za = b.pathBBox = function (a) {
        ...
        var l, m = 120 * R / 180, n = R / 180 * (+f || 0), o = [], p = e(function (a, b, c) {
          return {x: a * M.cos(c) - b * M.sin(c), y: a * M.sin(c) + b * M.cos(c)}
        });
      ...
      for (var Oa = function () {
        ...
        return z.doc.addEventListener ? function (a, b, c, d) {
          ...
          return a.attachEvent("on" + b, e), function () {
      ...
      kb.push = function () {
        ...
        for (var c = 0, d = this.items.length; d > c; c++) if (!1 === a.call(b, this.items[c], c)) return this;
        return this
      };
      ...
      return kb.attr = function (a, c) {
        ...
        if (A.was) z.win.Raphael = A.is; else {
    ...
    var d, e;
    !function (c) {
      var f, g, h = "0.4.2", i = "hasOwnProperty", j = /[\.\/]/, k = function () {
      }, l = function (a, b) {
        return a - b
      }, m = {n: {}}, n = function (a, b) {
        a = String(a);
        var c, d = g, e = Array.prototype.slice.call(arguments, 2), h = n.listeners(a), i = 0, j = [], k = {}, m = [],
          o = f;
        f = a, g = 0;
        for (var p = 0, q = h.length; q > p; p++) "zIndex" in h[p] && (j.push(h[p].zIndex), h[p].zIndex < 0 && (k[h[p].zIndex] = h[p]));
        for (j.sort(l); j[i] < 0;) if (c = k[j[i++]], m.push(c.apply(b, e)), g) return g = d, m;
        for (p = 0; q > p; p++) if ("zIndex" in (c = h[p])) if (c.zIndex == j[i]) {
          if (m.push(c.apply(b, e)), g) break;
          do {
            if (i++, c = k[j[i]], c && m.push(c.apply(b, e)), g) break
          } while (c)
        } else k[c.zIndex] = c; else if (m.push(c.apply(b, e)), g) break;
        return g = d, f = o, m.length ? m : null
      };
      n._events = m, n.listeners = function (a) {
        var b, c, d, e, f, g, h, i, k = a.split(j), l = m, n = [l], o = [];
        for (e = 0, f = k.length; f > e; e++) {
          for (i = [], g = 0, h = n.length; h > g; g++) for (l = n[g].n, c = [l[k[e]], l["*"]], d = 2; d--;) (b = c[d]) && (i.push(b), o = o.concat(b.f || []));
          n = i
        }
        return o
      }, n.on = function (a, b) {
        ...
        for (var c = a.split(j), d = m, e = 0, f = c.length; f > e; e++) d = d.n, d = d.hasOwnProperty(c[e]) && d[c[e]] || (d[c[e]] = {n: {}});
        for (d.f = d.f || [], e = 0, f = d.f.length; f > e; e++) if (d.f[e] == b) return k;
        ...
        if (!a) return void (n._events = m = {n: {}});
        var c, d, e, f, g, h, k, l = a.split(j), o = [m];
        for (f = 0, g = l.length; g > f; f++) for (h = 0; h < o.length; h += e.length - 2) {
          if (e = [h, 1], c = o[h].n, "*" != l[f]) c[l[f]] && e.push(c[l[f]]); else for (d in c) c[i](d) && e.push(c[d]);
          o.splice.apply(o, e)
        }
        for (f = 0, g = o.length; g > f; f++) for (c = o[f]; c.n;) {
          if (b) {
            if (c.f) {
              for (h = 0, k = c.f.length; k > h; h++) if (c.f[h] == b) {
                c.f.splice(h, 1);
                break
              }
              !c.f.length && delete c.f
            }
            for (d in c.n) if (c.n[i](d) && c.n[d].f) {
              var p = c.n[d].f;
              for (h = 0, k = p.length; k > h; h++) if (p[h] == b) {
                p.splice(h, 1);
                break
              }
    ...
    d = [c(1)], void 0 !== (e = function (a) {
      if (!a || a.svg) {
        ...
        var q = function (d, e) {
          ...
          if (!s) {
            if (e = c(e).replace(a._radial_gradient, function (a, b, c) {
              ...
              var v = [0, 0, f.cos(a.rad(u)), f.sin(a.rad(u))], w = 1 / (g(h(v[2]), h(v[3])) || 1);
          ...
          return q(o, {fill: t(k), opacity: 1, "fill-opacity": 1}), r.fill = l, r.opacity = 1, r.fillOpacity = 1, 1
        }, s = function () {
          ...
          for (var o in f) if (f[b](o)) {
            ...
            switch (k[o] = p, o) {
              ...
              case"title":
                ...
                if (s.length && (s = s[0])) s.firstChild.nodeValue = p; else {
                  s = q("title");
              ...
              case"clip-rect":
                ...
                break;
              case"path":
                "path" == d.type && (q(i, {d: p ? k.path = a._pathToAbsolute(p) : "M0,0"}), d._.dirty = 1, d._.arrows && ("startString" in d._.arrows && v(d, d._.arrows.startString), "endString" in d._.arrows && v(d, d._.arrows.endString, 1)));
                break;
              case"width":
              ...
              case"fill":
                ...
                if (F) {
                  ...
                  }(B), d.paper.defs.appendChild(B), q(i, {fill: "url(#" + B.id + ")"}), d.pattern = B, d.pattern && u(d);
                  break
                }
                var H = a.getRGB(p);
                if (H.error) {
              ...
              case"stroke":
                H = a.getRGB(p), i.setAttribute(o, H.hex), "stroke" == o && H[b]("opacity") && q(i, {"stroke-opacity": H.opacity > 1 ? H.opacity / 100 : H.opacity}), "stroke" == o && d._.arrows && ("startString" in d._.arrows && v(d, d._.arrows.startString), "endString" in d._.arrows && v(d, d._.arrows.endString, 1));
                break;
              case"gradient":
              ...
              case"fill-opacity":
                if (k.gradient) {
                  (I = a._g.doc.getElementById(i.getAttribute("fill").replace(/^url\(#|\)$/g, l))) && (J = I.getElementsByTagName("stop"), q(J[J.length - 1], {"stop-opacity": p}));
                  break
                }
              default:
        ...
        B.prototype = C, C.constructor = B, a._engine.path = function (a, b) {
          ...
          var d = new B(c, b);
          return d.type = "path", y(d, {fill: "none", stroke: "#000", path: a}), d
          ...
          if (a._extractTransform(this, c), this.clip && q(this.clip, {transform: this.matrix.invert()}), this.pattern && u(this), this.node && q(this.node, {transform: this.matrix}), 1 != d.sx || 1 != d.sy) {
          ...
          if (this.removed || !b) return this;
          var c = A(this.node), d = A(b.node || b[0].node);
    ...
    d = [c(1)], void 0 !== (e = function (a) {
      if (!a || a.vml) {
        var b = "hasOwnProperty", c = String, d = parseFloat, e = Math, f = e.round, g = e.max, h = e.min, i = e.abs,
          j = "fill", k = /[, ]+/, l = a.eve, m = " ", n = "",
          o = {M: "m", L: "l", C: "c", Z: "x", m: "t", l: "r", c: "v", z: "x"}, p = /([clmz]),?([^clmz]*)/gi,
          q = / progid:\S+Blur\([^\)]+\)/g, r = /-?[^,\s-]+/g,
          s = "position:absolute;left:0;top:0;width:1px;height:1px;behavior:url(#default#VML)", t = 21600,
          u = {path: 1, rect: 1, image: 1}, v = {circle: 1, ellipse: 1}, w = function (b) {
            ...
            var g = a._, h = a.matrix, k = g.fillpos, l = a.node, n = l.style, o = 1, p = "", q = t / b, r = t / c;
        ...
        var z = function (a, b, d) {
          ...
          if (q && (o.path = a._getPath[e.type](e), e._.dirty = 1), i.href && (l.href = i.href), i.title && (l.title = i.title), i.target && (l.target = i.target), i.cursor && (p.cursor = i.cursor), "blur" in i && e.blur(i.blur), (i.path && "path" == e.type || q) && (l.path = w(~c(o.path).toLowerCase().indexOf("r") ? a._pathToAbsolute(o.path) : o.path), e._.dirty = 1, "image" == e.type && (e._.fillpos = [o.x, o.y], e._.fillsize = [o.width, o.height], y(e, 1, 1, 0, 0, 0))), "transform" in i && e.transform(i.transform), r) {
            var A = +o.cx, C = +o.cy, D = +o.rx || +o.r || 0, F = +o.ry || +o.r || 0;
          ...
          if ("text" == s.type) {
            ...
            var T = s.paper.span, U = o.font && o.font.match(/\d+(?:\.\d*)?(?=px)/);
            ...
            for (var W = ["x", "y", "text", "font", "font-family", "font-weight", "font-style", "font-size"], X = 0, Y = W.length; Y > X; X++) if (W[X] in i) {
              s._.dirty = 1;
              break
            }
        ...
        C.prototype = D, D.constructor = C, D.transform = function (b) {
          ...
          var d, e = this.paper._viewBoxShift, f = e ? "s" + [e.scale, e.scale] + "-1-1t" + [e.dx, e.dy] : n;
          ...
          if (h.translate(1, 1), l || k || "image" == this.type) if (i.matrix = "1 0 0 1", i.offset = "0 0", g = h.split(), k && g.noRotation || !g.isSimple) {
            ...
            var o = this.getBBox(), p = this.getBBox(1), q = o.x - p.x, r = o.y - p.y;
            j.coordorigin = q * -t + m + r * -t, y(this, 1, 1, q, r, 0)
          } else j.style.filter = n, y(this, g.scalex, g.scaley, g.dx, g.dy, g.rotate); else j.style.filter = n, i.matrix = c(h), i.offset = h.offset();
          ...
          var d = new C(c, b), e = {fill: "none", stroke: "#000"};
          ...
          var e = a.path();
          e.attrs;
          return e.X = b - d, e.Y = c - d, e.W = e.H = 2 * d, e.type = "circle", A(e, {cx: b, cy: c, r: d}), e
          ...
          var h = E("shape"), i = E("path"), j = E("textpath");
          ...
          var k = new C(h, b), l = {fill: "#000", stroke: "none", font: a._availableAttrs.font, text: g};
  ...
  b = window.Morris = {}, a = jQuery, b.EventEmitter = function () {
    ...
    return h(c, a), c.prototype.init = function () {
      if ("always" !== this.options.hideHover) return this.hover = new b.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)
      ...
      for (k = "", c && (g = b.Line.gradients(a)), l = {y: null}, h = q = 0, r = a.length; q < r; h = ++q) e = a[h], null != e.y && (null != l.y ? c ? (f = g[h], j = g[h - 1], i = (e.x - l.x) / 4, m = l.x + i, o = Math.min(d, l.y + i * j), n = e.x - i, p = Math.min(d, e.y - i * f), k += "C" + m + "," + o + "," + n + "," + p + "," + e.x + "," + e.y) : k += "L" + e.x + "," + e.y : c && null == g[h] || (k += "M" + e.x + "," + e.y)), l = e;
      return k
    }, c.gradients = function (a) {
      var b, c, d, e, f, g, h, i;
      for (c = function (a, b) {
        return (a.y - b.y) / (a.x - b.x)
      }, i = [], d = g = 0, h = a.length; g < h; d = ++g) b = a[d], null != b.y ? (e = a[d + 1] || {y: null}, f = a[d - 1] || {y: null}, null != f.y && null != e.y ? i.push(c(f, e)) : null != f.y ? i.push(c(f, b)) : null != e.y ? i.push(c(b, e)) : i.push(null)) : i.push(null);
      return i
    }, c.prototype.hilight = function (a) {
      var b, c, d, e, f;
      if (null !== this.prevHilight && this.prevHilight !== a) for (b = c = 0, e = this.seriesPoints.length - 1; 0 <= e ? c <= e : c >= e; b = 0 <= e ? ++c : --c) this.seriesPoints[b][this.prevHilight] && this.seriesPoints[b][this.prevHilight].animate(this.pointShrinkSeries(b));
      if (null !== a && this.prevHilight !== a) for (b = d = 0, f = this.seriesPoints.length - 1; 0 <= f ? d <= f : d >= f; b = 0 <= f ? ++d : --d) this.seriesPoints[b][a] && this.seriesPoints[b][a].animate(this.pointGrowSeries(b));
    ...
    if (j = 200 * (d - c) / e, i = new Date(c), void 0 === (n = b.LABEL_SPECS[f])) for (r = b.AUTO_LABEL_ORDER, p = 0, q = r.length; p < q; p++) if (k = r[p], m = b.LABEL_SPECS[k], j >= m.span) {
      n = m;
      break
    }
    ...
    return h(d, c), d.prototype.init = function () {
      if (this.cumulative = this.options.stacked, "always" !== this.options.hideHover) return this.hover = new b.Hover({parent: this.el}), this.on("hovermove", this.onHoverMove), this.on("hoverout", this.onHoverOut), this.on("gridclick", this.onGridClick)
